<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="descripcion">Categoria o Tipo de Evento</label>
        <select 
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="descripcion">Selecciona el Día</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label class="formulario__label" for="ponentes">Expositor</label>
        <input 
        type="text" 
        class="formulario__input"
        id="ponentes"
